...
### NewSpace Operators
| Company | HQ | Satellites | Contact Entry Point | Notes |
|---|---|---|---|---|
| Planet Labs | San Francisco, CA | 200+ Doves | VP Engineering, Head of Ground Ops | Public company, budget confirmed |
| Spire Global | Vienna, Austria | 110+ LEMUR | CTO, VP Operations | AIS/ADS-B/weather data — rich telemetry |
| Satellogic | Buenos Aires | 36+ | Head of Satellite Operations | High-cadence imaging |
| Iceye | Espoo, Finland | 35+ SAR | VP Engineering | SAR constellation, EU-funded |
| Capella Space | San Francisco, CA | 10+ | CTO | SAR, Series C |
| HawkEye 360 | Herndon, VA | 21+ | Head of Ops | RF signal intelligence |
| Umbra | Santa Barbara, CA | 7+ | Engineering team | SAR startup |
| Orbital Sidekick | San Francisco, CA | 6 | CTO | Hyperspectral imaging |

### Launch + Smallsat Platforms
| Company | Notes |
|---|---|
| Rocket Lab | Electron telemetry, Photon platform |
| ABL Space Systems | RS1 launch vehicle telemetry |
| Exolaunch | Rideshare deployer — contacts hundreds of operators |
| D-Orbit | In-orbit transportation — telemetry hub opportunity |

---

## Tier 2 — Good Fit (Traditional operators modernizing)

| Company | HQ | Notes |
|---|---|---|
| SES | Luxembourg | 70+ GEO + O3b MEO, large ops team |
| Eutelsat | Paris | 35+ GEO, modernization push |
| Telesat | Ottawa | Lightspeed LEO constellation (300+ sats incoming) |
| Intelsat | McLean, VA | 50+ GEO, recently emerged from bankruptcy — cost pressure |
| SkyBridge/Thales Alenia | France | Building LEO — early conversations valuable |
| ViaSat | Carlsbad, CA | ViaSat-3 constellation ops |

---

## Tier 3 — Research / Agency (Validation + PR value)

| Organization | Contact | Value |
|---|---|---|
| NASA JPL | Telemetry system teams | Used SMAP/MSL dataset — natural fit |
| ESA ESOC | Darmstadt, Germany | Ground ops center for all ESA missions |
| DLR | Germany | German aerospace center |
| JAXA | Japan | Good for APAC expansion |
| ISRO | India | Growing commercial ops |
| Space Norway | Norway | Arctic satellite ops |
| KSAT | Tromsø, Norway | Largest commercial ground station network |

---

## Tier 4 — Accelerators / Investors (If raising)
...
| Bessemer Venture Partners | VC | Spire, other space investments |
| Founders Fund | VC | SpaceX-adjacent, deep tech |
| 2048 Ventures | VC | Early-stage frontier tech |
| Starburst Aerospace | Accelerator | Paris + LA, global aerospace network |
| Techstars Starburst | Accelerator | NYC aerospace cohort |
...
For finding the right contact at each company:
...
## Conference Circuit (in-person opportunities)

| Conference | Date | Location | Attendees |
|---|---|---|---|
| SmallSat | August | Logan, UT | 3,000+ smallsat community |
| IAC (Int'l Astronautical Congress) | October | varies | 5,000+ global space |
| Space Symposium | April | Colorado Springs | Government + commercial |
| SATELLITE Conference | March | Washington DC | 15,000+ industry |
...
Before sending to any company, check:
1. Their current satellite count (Celestrak, their press releases)
2. Recent funding announcement (shows budget availability)
