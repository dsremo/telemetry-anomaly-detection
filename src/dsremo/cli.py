...
async def _run_simulator(
    ...
    from dsremo.simulate.injector import SCENARIOS, apply_scenario
...
def scenarios() -> None:
    ...
    from dsremo.simulate.injector import list_scenarios
...
async def _create_user(email: str, password: str, role: str, tenant_id: str) -> None:
    ...
    from dsremo.db.queries import create_user
...
async def _list_users(tenant_id: str) -> None:
    ...
    from dsremo.core.tenant import set_tenant
    from dsremo.db.connection import close_pool, init_pool
    from dsremo.db.queries import list_users
...
async def _deactivate_user(email: str, tenant_id: str) -> None:
    ...
    from dsremo.core.tenant import set_tenant
    from dsremo.db.connection import close_pool, init_pool
    from dsremo.db.queries import deactivate_user, revoke_all_user_tokens, get_user_by_email
...
async def _store_key(key_hash: str, label: str) -> None:
    from dsremo.core.config import load_config
    from dsremo.db.connection import close_pool, init_pool
    from dsremo.db.queries import store_api_key
...
async def _revoke_key(hash_prefix: str) -> None:
    from dsremo.db.connection import acquire, close_pool, init_pool
    from dsremo.core.config import load_config
...
async def _create_dsremo_user(email: str, password: str, role: str) -> None:
    ...
    from dsremo.core.security import hash_password
    from dsremo.db.connection import close_pool, init_pool
    from dsremo.db.queries import create_dsremo_user
...
async def _list_dsremo_users() -> None:
    from dsremo.core.config import load_config
    from dsremo.db.connection import close_pool, init_pool
    from dsremo.db.queries import list_dsremo_users
