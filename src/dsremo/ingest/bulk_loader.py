...
from dsremo.core.models import Anomaly, TelemetryPoint
...
from dsremo.ingest.utils import prepare_series, validated_satellite_id
...
async def run_bulk_detection(
    ...
    """
    import dsremo.detection.detector as _det_mod
