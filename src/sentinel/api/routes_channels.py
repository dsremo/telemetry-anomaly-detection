...
from sentinel.api.dependencies import require_operator, require_viewer
from sentinel.api.schemas import ChannelConfigIn, ChannelConfigOut, ChannelOut
from sentinel.detection.detector import get_effective_thresholds, load_channel_configs
...
async def put_channel_config(
    ...
    all_configs = await queries.load_all_channel_configs()
    load_channel_configs(all_configs)
